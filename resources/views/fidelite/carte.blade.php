...
<body>
    ...
    <img id="pattern1" src="/assets/pattern-waves.svg" alt="Pattern waves background">
        ...
        <span style="top: 45%; font-size: 20px; font-weight: 600; color: #404040;">{{ $client->surname }} {{ $client->user ? $client->user->nom : '' }}</span>
        <div class="qr-code">
            <img src="{{ 'https://api.qrserver.com/v1/create-qr-code/?data=' . urlencode($client->telephone) }}" alt="QR Code">
        </div>
    </div>
</body>
</html>
